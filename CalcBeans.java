...
public class CalcBeans extends javax.swing.JFrame{
...
//	public class CalcBeans extends javax.swing.JFrame {
	    ...
	    /**
	     * Creates new form CalcBeans
	     */
	    public CalcBeans() {
	        super("Cal-C by Rishabh");
	    	first = Float.MIN_VALUE;
	    	second = Float.MIN_VALUE;
	    	zero = Float.MIN_VALUE;
	    	prevOP = '#';
	    	operation = '#';
	        initComponents();
	    }
	    ...
	    private void initComponents() {
	        ...
	        setResizable(false);
	        jRadioButton1.setLabel("Simple");

	        jRadioButton2.setLabel("Scientific");
	        ...
	        jRadioButton2.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					JOptionPane.showMessageDialog(null, "Scientific Version is Not Free and has to be purchased", "Scientific Calculator", JOptionPane.PLAIN_MESSAGE);
	                ...
	                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
	                    ...
	                    .addGroup(layout.createSequentialGroup()
	                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
	                            ...
	                            .addComponent(jButton9, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
	                        .addGap(18, 18, 18)
	                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	                            .addGroup(layout.createSequentialGroup()
	        ...
	        layout.setVerticalGroup(
	            ...
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	                    ...
	                    .addComponent(jButton16, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))
	    ...
	    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {                                          
	        // TODO add your handling code here:'/'
	    	try{
	    		if(first==Float.MIN_VALUE){
	    			first = Float.parseFloat(jTextArea1.getText());
	    			prevOP = '/';
	    		}
	    		else{
	    			zero = first;
	    			first = Float.parseFloat(jTextArea1.getText());
	    			first = Float.parseFloat(operate(zero, first, prevOP));
	    			prevOP = '/';
	    		}
	    		operation = '/';
	    		jTextArea1.setText("");
	    		...
	    		jTextArea1.setText("Input MisMatch:Syntax Error");
	    	}
	    }                                         
	    ...
	    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {                                          
	    	...
	    	try{
	    		...
	    		second = Float.parseFloat(jTextArea1.getText());
	    		jTextArea1.setText(Float.toString(first));
	    		jTextArea1.setText(operate(first,second,operation));
	    		first = Float.MIN_VALUE;
		        second = Float.MIN_VALUE;
	    	}
	    	catch(InputMismatchException e){
	    ...
	    private String operate(float first2, float second2, char operation2) {
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(CalcBeans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
